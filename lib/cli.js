...
export async function runCli(argv = []) {
    ...
    switch (cmd) {
        ...
        default:
            ...
            logger.info(`
Usage:        
        rbuild create <project-name> --artifactPath="path_to_react_project"  "Create new React Project"
        rbuild dev --artifactPath="path_to_react_project"                    "Start dev server"
        rbuild build --artifactPath="path_to_react_project"                  "Build for production"
        rbuild prod --artifactPath="path_to_react_project"                   "Test the build project locally" 
`);
    }
}